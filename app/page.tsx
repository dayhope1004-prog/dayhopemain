    ...
    <div className="bg-black text-white min-h-screen font-sans">
      ...
      <section className="pt-20 pb-16 px-6 text-center border-b border-gray-800">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-gold-500 text-lg font-bold mb-4 tracking-widest uppercase text-yellow-500">
            DayHope Exclusive
          </h2>
      ...
      <section id="pricing" className="py-24 px-6 text-center">
        <div className="max-w-2xl mx-auto border-2 border-yellow-500 p-12 rounded-3xl bg-zinc-900">
          ...
          <button className="w-full bg-yellow-500 text-black py-5 rounded-xl text-2xl font-black hover:scale-105 transition-transform">
            프롬프트 가이드 즉시 다운로드
          </button>
          <p className="mt-6 text-gray-500 text-sm">결제 완료 시 이메일로 즉시 발송됩니다.</p>
        </div>
      </section>
